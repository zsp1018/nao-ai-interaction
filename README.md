# 基于Nao 机器人 AI 交互的 儿童陪伴机器人🧸Demo

本项目利用电脑本地大语言模型 (Llama 3) 为 Nao 机器人赋予智能语音交互和动作控制能力。

> **⚠️ 重要说明**
>
> *   **模型扩展性**：当前电脑默认配置使用的是 Llama 3 **8B** 模型。如果你拥有更强大的硬件资源例如 **Thor** 等高性能推理框架，完全可以部署 **70B** 或更大参数的模型，以获得更深度的理解能力和更惊艳的交互体验.
